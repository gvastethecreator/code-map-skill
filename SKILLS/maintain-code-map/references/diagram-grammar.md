...
- A three-stop wash uses the card hue mixed darker. Diagonal, top to bottom — not button lighting.
...
- Group hues are blues, violets, magentas, reds, oranges, golds first. Greens last. Keep saturation a step less than neon.
